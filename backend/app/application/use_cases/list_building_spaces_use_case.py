...
class ListBuildingSpacesUseCase:
    ...
    def __init__(self, building_space_repository: BuildingSpaceRepositoryInterface) -> None:
        ...
        self.__repository = building_space_repository
    ...
    def execute(self, dto: ListBuildingSpacesInputDTO) -> list[ListBuildingSpacesOutputDTO]:
        ...
        building_spaces = self.__repository.get_building_spaces_by_building_id(dto.building_id)
