...
class UpdateLostItemController:

    """Ponto de acesso entre o endpoint /lost-items/{item_id} e o caso de uso UpdateLostItemUseCase"""

    def __init__(self, use_case: UpdateLostItemUseCase) -> None:

        """Inicializa os atributos de instância de UpdateLostItemController

        Parameters
        ----------
        use_case: UpdateLostItemUseCase
            Caso de uso de atualização de item perdido
    ...
    def handle(self, http_request: HttpRequest) -> HttpResponse:
        ...
        """Atualiza um item perdido com os dados obtidos do endpoint
        ...
        try:
            ...
            return HttpResponse(
                200,
                {
                    "message": "Item perdido atualizado com sucesso",
                }
            )
