...
from backend.app.presentation.controllers.factories.user_account_factories import (
    make_register_user_account_controller,
    make_get_user_account_details_controller,
)
...
def create_user_account_routes(app: Flask) -> None:
    ...
    def get_user_account_details():
        ...
        with SessionManager(database_url) as session_manager:
            ...
            get_user_account_details_controller = make_get_user_account_details_controller(
                session_manager.session
            )

            http_response = get_user_account_details_controller.handle(http_request)
