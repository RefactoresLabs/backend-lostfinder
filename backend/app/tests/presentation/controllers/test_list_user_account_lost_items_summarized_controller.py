...
def test_list_user_account_lost_items_summarized_controller_success():
    ...
    controller = ListUserAccountLostItemsSummarizedController(use_case)
...
def test_list_user_account_lost_items_summarized_controller_user_not_found():
