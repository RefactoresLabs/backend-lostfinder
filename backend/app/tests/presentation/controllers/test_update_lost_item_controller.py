...
def test_update_lost_item_controller_success():
    use_case = Mock()
    use_case.execute.return_value = None

    controller = UpdateLostItemController(use_case)
    ...
    assert http_response.body["message"] == "Item perdido atualizado com sucesso"


def test_update_lost_item_controller_missing_required_fields():
    use_case = Mock()
...
def test_update_lost_item_controller_empty_field():
    use_case = Mock()
...
def test_update_lost_item_controller_item_not_found():
    use_case = Mock()
...
def test_update_lost_item_controller_category_not_found():
    use_case = Mock()
...
def test_update_lost_item_controller_building_space_not_found():
    use_case = Mock()
